...
//     koneksi.query(
//       updateQuery,
//       [gdgWeight, gdgLocation],
//       (updateErr, updateResult) => {
//         if (updateErr) {
//           return res
//             .status(500)
//             .json({ message: "Gagal update loc_weiutil!", error: updateErr });
//         }

//         res.status(201).json({
//           success: true,
//           message: "Berhasil insert data stok dan update loc_weiutil!",
//         });
//       }
//     );
//   });
...
router.get("/:gdg_ID", gudangController.getGudangById);
router.put("/:gdg_ID", gudangController.updateGudang);
router.delete("/:gdg_ID", gudangController.deleteGudang);

// ========= get one record data
// router.get("/:gdg_ID", (req, res) => {
...
//     return res
//       .status(400)
//       .json({ message: "Nama bansos melebihi 100 karakter" });
...
//           res
//             .status(200)
//             .json({ success: true, message: "Berhasil update data stok!" });
//         }
//       );
//     } else {
//       return res
//         .status(404)
//         .json({ message: "Data stok tidak ditemukan!", success: false });
//     }
//   });
// });
